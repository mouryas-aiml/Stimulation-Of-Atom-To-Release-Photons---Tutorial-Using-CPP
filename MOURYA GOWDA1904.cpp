...
void projectwork1()
{
  ...
  circle(250,180,8);
  circle(250,280,8);
  floodfill(250,180,WITE):
  floodfill(250,280,WITE);
  delay(500);
...
circle(190,110,5);
floodfill(190,110,WITE);
setcolor(GREEN);

outtextxy(176,120,"PHOTON");
delay(2000);
setcolor(BLUE);
outtextxy(170,120,"POTON");
...
circle(210,130,5);
setfillstyle(1,GREEN);
floodfi11(210,130,WHITE);
delay(300);
setfillstyle(1,BLACK);
floodrill(210,130,WHITE);
setcolor(BLACK);
circle(210,130,5);
...
void projectwork3()
{
    ...
    ellipse(200,230,90,89,15,70);
    setfillstyle(1,BLUE);
    floodfill(205,232,WHITE);
    ellipse(460,230,90,89,15,70);
    setfillstyle(1,CYAN);
    floodfill(465,232,WHITE);

    rectangle(300,365,360,380);
    setfillstyle(1,RED);
    ...
    outtextxy(128,85,"PHOTON");
    setcolor(WHITE);
    setfillstyle(1,RED);

     circle(365,205,8);
    floodf ill(365,205,WITE);

    circle(325,285,8);
    floodf ill(325,285,WITE);
    delay(3000);

    circle(325,260,0);
    floodf ill(325,260,WHITE);
    ...
    circle(395,220,3);
    floodfill(395,220,WITE);
    circle(305,225,3);

    floodfill(305,225,WHITE);
    circle(325,245,3);
    floodfill(325,245,WITE);
    delay(100);
    circle(345,265,3);
    floodfill(345,265,WITE);
    delay(100);
    circle(345,235,3);
    floodfill(345,235,IHITE);
    delay(100);
    circle(365,285,3);
    floodfill(365,285,WITE);
    circle(365,230,3);
    floodfill(365,230,WITE);
    delay(100);
    circle(395,245,3);
    ...
    void closing()ss
 {
    ...
    outtextxy(160,180,"THANK YOU FOR WATCHING");
    outtextxy(120,280,"CODING By MOURYA GOWDA Dr.AIT");
 }